...
var gwta = [] // graphWorkerThreadsArrays
cushion.oninput()
...
function makeGraph()
{
  ...
  let chartOptions = {
    'title':'EEG (normalized) [first 2k points]',
//          curveType: 'function',
    backgroundColor: { fill:'transparent' },
    hAxis: { viewWindow: { min: 0, max: 2000 }, gridlines: { color:'transparent' },
//      ticks: [5,10,15,20,25,30] 
    ...
    'height':200,
    series: {
            0: {color: color,  pointShape: 'circle', pointSize: 1},
          },
    legend: 'none'
    // ,isStacked: true
    };
...
console.log(xy)
  ...
  return { dataTable:window.dataTable, chart:window.chart, xy:xy, plot:plot}
}
